...
const ADMIN_ROUTE_RULES = {
  ...
  hasil: { key: "hasil", adminOnly: false, paths: ["/admin/analitik"] },
...
const navGroups: NavGroup[] = [
  ...
  {
    id: "pelaksanaan-ujian",
    label: "Pelaksanaan Ujian",
    icon: FileText,
    items: [
      { to: "/admin/ujian", label: "Ujian", icon: FileText },
      { to: "/admin/peserta/online", label: "Pantau Ujian Live", icon: Activity },
    ],
  },
  {
    id: "penilaian-hasil",
    label: "Penilaian & Hasil",
    icon: BarChart3,
    items: [
      { to: "/admin/evaluasi", label: "Penilaian Essay", icon: PenLine },
      { to: "/admin/analitik", label: "Hasil Ujian", icon: BarChart3 },
    ],
  },
  {
